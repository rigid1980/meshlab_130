...
*                                                                           *
****************************************************************************/
#ifndef __MULTIDOCVIEWER_CONTAINER_H__
#define __MULTIDOCVIEWER_CONTAINER_H__
...
class MultiDocViewer_Container;
/*
...
public:
	...
	MultiDocViewer_Container *getRootContainer();
...
*/
class MultiDocViewer_Container : public Splitter
{
	Q_OBJECT
...
public:
    MultiDocViewer_Container(QWidget *parent);
    ~MultiDocViewer_Container() {}
...
#endif // __MULTIDOCVIEWER_CONTAINER_H__
